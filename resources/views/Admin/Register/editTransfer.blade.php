                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h3 class="card-title">Old University Details</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <label for="olduniversitycountry">Old University Country</label>
                                        <input type="text" value="{{ $register->oldUniCountry }}"
                                            name="olduniversitycountry" id="olduniversitycountry" class="form-control"
                                            placeholder="Old University Country">
                                        @error('olduniversitycountry')
                                            <div style="color: red">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        <label for="olduniversitymajor">Old University Major</label>
                                        <input type="text" value="{{ $register->oldUniMajor }}"
                                            name="olduniversitymajor" id="olduniversitymajor" class="form-control"
                                            placeholder="Old University Major">
                                        @error('olduniversitymajor')
                                            <div style="color: red">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
